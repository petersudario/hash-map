...
/**
 * Implementação abstrata de tabela hash com encadeamento separado, fator de
 * carga e redimensionamento automático.
 *
...
public abstract class AbstractHashTable<K> {
    ...
    /**
     * Retorna a chave armazenada se existir, ou null.
     */
    public K get(K key) {
        int idx = normalize(hash(key));
